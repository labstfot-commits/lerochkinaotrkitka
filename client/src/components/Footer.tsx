...
export default function Footer() {
  return (
    <footer className="py-16 px-4 bg-card border-t border-card-border" data-testid="section-footer">
      <div className="max-w-4xl mx-auto text-center space-y-6">
        <div className="flex items-center justify-center gap-2">
          ...
          <Heart className="text-primary w-6 h-6 animate-heartbeat" style={{ animationDelay: '0.5s' }} />
        </div>
